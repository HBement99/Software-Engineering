...
def main():
    ...
    print("Here is an example of squaring or using an exponent of the number which was input ", vitality ** 5)
    #  This is an example of an exponentiation, and it gives the product of two variables multiplied by
    #  itself another.
    ...
    while control:
        ...
        if ans.lower() == "no":
            ...
            for weapons in weapons:
                ...
                print(
                    len(weapons))
                # prints out how long each individual string is within the list when put into for loop.
...
def function1(game):  # Defines the function chosen (game) which I am able to call later in the program.
    print("Hunter " + game)

    h = 524  # received help from W3 Schools.
    print(h > 511 or 814 < h)  # Returns True due to Var H being greater than 511 and less than 814.

    print("\n")

    h = 550
    print(not (h > 500 or 575 < h))  # It would return True, but due to the not operator it switches it to False

    print("\n")

    h = 520
    print(h > 510 and 530 < h)  # It would only return True if both statements in the print statement are True.
